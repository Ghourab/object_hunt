...
class ProfileScoreSeeker extends ConsumerStatefulWidget {
  const ProfileScoreSeeker({Key? key}) : super(key: key);

  @override
  ConsumerState<ProfileScoreSeeker> createState() => _ProfileScoreState();
}

class _ProfileScoreState extends ConsumerState<ProfileScoreSeeker> {
